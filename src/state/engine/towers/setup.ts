...
const gameConfig = {
  ...
  startingPlayerPieces: [
    { size: 2, player: 0, x: 0, y: 1 },
    { size: 2, player: 0, x: 5, y: 6 },
    { size: 2, player: 0, x: 6, y: 5 },
    { size: 2, player: 1, x: 0, y: 5 },
    { size: 2, player: 1, x: 1, y: 6 },
    { size: 2, player: 1, x: 5, y: 0 },
    { size: 2, player: 1, x: 6, y: 1 },
    { size: 2, player: 0, x: 1, y: 0 },
  ],
};
